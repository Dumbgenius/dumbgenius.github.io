...
Game.canvas.addEventListener("touchstart", function(e) {Game.mousedown(e.changedTouches[0].clientX, e.changedTouches[0].clientY); if(Game.dragging) {e.preventDefault()}})
Game.canvas.addEventListener("touchmove",  function(e) {Game.mousemove(e.changedTouches[0].clientX, e.changedTouches[0].clientY); if(Game.dragging) {e.preventDefault()}})
